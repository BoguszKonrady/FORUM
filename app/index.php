...
<nav class="navbar navbar-expand-lg navbar-light menu">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="logout.php">Wiadomości</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="logout.php">Powiadomienia</a>
            </li>
            <li class="nav-item">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-2">
            <div class="sidebar">
                <button class="btn btn-outline-primary btn-block">Znajomi</button>
                <button class="btn btn-outline-primary btn-block">Wydarzenia</button>
                <button class="btn btn-outline-primary btn-block">Grupy</button>
                <button class="btn btn-outline-primary btn-block">Ulubione</button>
            </div>
        </div>
        <div class="col-md-8">
