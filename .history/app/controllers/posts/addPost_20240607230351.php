...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $sql = "INSERT INTO posts (user_id, content, image_url, created_at) VALUES (:user_id, :content, :image_url, NOW())";
        ...
        if ($stmt->execute()) {
            echo "<script type='text/javascript'>alert('Post added successfully!'); window.location.href = '/views/dashboard.php';</script>";
        } else {
