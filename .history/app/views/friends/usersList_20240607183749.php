...
<?php include '/var/www/html/controllers/firends/usersList.php'; ?>
<div class="container-fluid">
    <div class="row mt-3">
        ...
        <div class="col-md-6">
            <?php include '/var/www/html/views/friends/usersList.php'; ?>
        </div>
        <div class="col-md-3 sidebar">
            <!-- Możesz dodać inne elementy lub zostawić to puste -->
        </div>
    </div>
</div>
</div>
