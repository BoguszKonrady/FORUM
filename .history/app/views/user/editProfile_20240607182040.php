    ...
    <div class="col-md-6 form-container">
        ...
        <form action="/controllers/user/editProfile.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">Pozostaw puste jeżeli nie chcesz zmienić hasła</small>
            </div>
            <button type="submit" class="btn btn-primary w-100">Zaaktualizuj profil</button>
        </form>
    </div>
</div>